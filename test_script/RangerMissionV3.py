...
2023.07.12 Some changes to the dronekit library to add new features (e.g. force arm vehicles)
Version 20230712
...
def control_tab(thisport):
    """
    The new version of the control tab, due to a limitation of the pysimplegui library, 
    does not delete the tab after disconnecting the vehicle, 
    but hides the tab until the port with the same name gets connected again and the tab is displayed.
    """
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Mission 1 is a single execution task that can be interrupted at any time, 
        # and the vehicle switches to RTL mode after the task is completed or the abort mission 1 button is pressed.
        ...
        # Note: vehicles will change to RTL mode after pressing this button
        ...
        # Event: Start Mission 2 button pressed
        # ------------------------------------------------------------------
